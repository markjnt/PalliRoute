...
export const TopOverviewBar: React.FC<TopOverviewBarProps> = ({ onUserSwitch, onSheetToggle, onSheetClose }) => {
  ...
  const handleWeekdayButtonClick = () => {
    ...
    onSheetClose(); // Close the MainBottomSheet when opening weekday selector
  };
